...
const Funiro = () => {
  return (
    <div>
      <div>
        <div className=" w-full mt-20 lg:mt-[115px]">
        ...
        <div className="Image-Container px-5 lg:mx-10 lg:overflow-x-auto">

          <div className="lg:flex-row lg:justify-center items-center  flex flex-col mt-5 gap-4">
          ...
          <div className="lg:flex-row lg:justify-center mt-5 flex flex-col gap-4">
            <img  className="w-[381px] h-[323px]" alt="Product-Image4" src={Share4} />
            <img className="w-[344px] h-[242px]" alt="Product-Image5" src={Share5} />
            <img className="w-[178px] h-[242px]" alt="Product-Image6" src={Share6} />
