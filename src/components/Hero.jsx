  ...
  return (
    <section className="container mx-auto">
      <div className="bg-[#F9F1E7]">
        <div className="sm:pt-20 px-[5px] sm:px-2 lg:pl-[5px] lg:pr-[13px] relative">
          ...
          <div className="py-10 px-3 sm:py-0 sm:absolute sm:top-0 md:pl-4 xxl:pl-[100px]">
            <div className="mx-auto w-full sm:w-[270px] md:w-[304px] lg:w-[404px] xl:w-[494px] bg-[rgba(255,255,255,.72)] backdrop-filter backdrop-blur">
              <div className="py-6 px-6 sm:py-4 md:py-6 lg:p-9 xl:pl-12 xxl:py-[60px] xxl:pl-[60px]">
                ...
                <button className="py-3 px-10 lg:py-4 xl:py-6 xl:pl-[140px] xl:pr-[132px] bg-primary cursor-pointer hover:bg-transparent hover:border-2 hover:border-primary hover:text-primary font-black text-white text-base lg:text-xl">Shop Now</button>
              </div>
            </div>
          </div>
        </div>
